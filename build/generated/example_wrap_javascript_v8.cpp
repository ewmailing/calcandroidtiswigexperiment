...
void _wrap_My_variable_set(v8::Local<v8::String> property, v8::Local<v8::Value> value, const v8::AccessorInfo& info) {
  v8::HandleScope scope;
  double arg1 ;
  double val1 ;
  int ecode1 = 0 ;
...
v8::Handle<v8::Value> _wrap_My_variable_get(v8::Local<v8::String> property, const v8::AccessorInfo& info) {
  v8::HandleScope scope;
...
extern "C" {
  ...
  void example_initialize(v8::Handle<v8::Object> global_obj)
  {
    ...
    SWIGV8_AddStaticVariable(example_obj, "My_variable", _wrap_My_variable_get, _wrap_My_variable_set);
    ...
    global_obj->Set(v8::String::NewSymbol("swigex"), example_obj);
    
  }
  
  /*
  void example_initialize(void* v8_global_obj)
  {
	  internal_example_initialize((v8::Handle<v8::Object>)v8_global_obj);
  }
  */
} // extern "C"
